; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25508.2 
	...
	TITLE	C:\Users\pierr\Documents\UQAC\Cours\Intelligence artificielle pour le jeu vidéo - 8IAR125\IA\source projet IA\Buckland_Chapter7 to 10_Raven\armory\Projectile_Slug.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG168755 DB	'Slug_MaxForce', 00H
	ORG $+2
$SG168756 DB	'Slug_Mass', 00H
	ORG $+2
$SG168757 DB	'Slug_MaxSpeed', 00H
	ORG $+2
$SG168758 DB	'Slug_Scale', 00H
	ORG $+1
$SG168759 DB	'Slug_Damage', 00H
$SG168760 DB	'Slug_Persistance', 00H
	ORG $+3
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\pierr\documents\uqac\cours\intelligence artificielle pour le jeu vidéo - 8iar125\ia\source projet ia\buckland_chapter7 to 10_raven\armory\projectile_slug.cpp
_TEXT	SEGMENT
$T1 = -140						; size = 16
$T2 = -124						; size = 16
$T3 = -108						; size = 16
...
; 20   :         Raven_Projectile(target,
	...
	push	OFFSET $SG168755
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG168756
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG168757
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG168758
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG168759
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pierr\documents\uqac\cours\intelligence artificielle pour le jeu vidéo - 8iar125\ia\source projet ia\buckland_chapter7 to 10_raven\armory\projectile_slug.h
