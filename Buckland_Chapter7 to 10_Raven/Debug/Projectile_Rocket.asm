; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25508.2 
	...
	TITLE	C:\Users\pierr\Documents\UQAC\Cours\Intelligence artificielle pour le jeu vidéo - 8IAR125\IA\source projet IA\Buckland_Chapter7 to 10_Raven\armory\Projectile_Rocket.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG168761 DB	'Rocket_MaxForce', 00H
$SG168762 DB	'Rocket_Mass', 00H
$SG168763 DB	'Rocket_MaxSpeed', 00H
$SG168764 DB	'Rocket_Scale', 00H
	ORG $+3
$SG168765 DB	'Rocket_Damage', 00H
	ORG $+2
$SG168766 DB	'Rocket_BlastRadius', 00H
	ORG $+1
$SG168767 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	...
	ORG $+2
$SG168768 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
	DB	' ', 00H, '!', 00H, '=', 00H, ' ', 00H, 'V', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'o', 00H, 'r', 00H, '2', 00H, 'D', 00H, '(', 00H
	DB	')', 00H, 00H, 00H
	ORG $+2
$SG168782 DB	'Rocket_ExplosionDecayRate', 00H
	ORG $+2
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\pierr\documents\uqac\cours\intelligence artificielle pour le jeu vidéo - 8iar125\ia\source projet ia\buckland_chapter7 to 10_raven\armory\projectile_rocket.cpp
_TEXT	SEGMENT
tv203 = -44						; size = 8
$T1 = -36						; size = 16
$T2 = -20						; size = 16
...
; 32   :    assert (target != Vector2D());
	...
	push	32					; 00000020H
	push	OFFSET $SG168767
	push	OFFSET $SG168768
	call	__wassert
	add	esp, 12					; 0000000cH
$LN3@Rocket:
